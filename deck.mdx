...
# How to create your `Portfolio` w/ `GitHub Pages`
<p> by Athul-CA</p>
---
...
You should initialize  without    
the Readme(for this one's purpose only)
...
### Now we need to add the Remote of the Repository
 ...
 This can also be found from your repository page on Github and you can copy from there.
---
export default Layout
...
You can remix it as a Blog or   
 You can simply show it off to your __Friends__    
   :smiling_imp:
